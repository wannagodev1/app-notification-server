...
public class MailServiceEndpoint extends BaseEndpoint {
  ...
  public ResponseEntity<ServiceResult> findAnyMatching(@RequestBody FindAnyMatchingQuery query) {
    ...
    try {
      Page<org.wannagoframework.notification.domain.Mail> result = mailService
          .findAnyMatching(query.getFilter(),
              mapperFacade.map(query.getPageable(),
                  Pageable.class, getOrikaContext(query)));
      org.wannagoframework.dto.utils.Page<Mail> convertedResult = new org.wannagoframework.dto.utils.Page<>();
