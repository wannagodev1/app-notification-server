...
public class CloudNotificationMessageServiceEndpoint extends BaseEndpoint {
  ...
  public ResponseEntity<ServiceResult> findAnyMatching(@RequestBody FindAnyMatchingQuery query) {
    ...
    try {
      Page<org.wannagoframework.notification.domain.CloudNotificationMessage> result = cloudNotificationMessageService
          .findAnyMatching(query.getFilter(),
              mapperFacade.map(query.getPageable(),
                  Pageable.class, getOrikaContext(query)));
      org.wannagoframework.dto.utils.Page<CloudNotificationMessage> convertedResult = new org.wannagoframework.dto.utils.Page<>();
